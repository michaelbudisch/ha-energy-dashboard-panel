...
_SENSOR_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_SOLAR_ENERGY, default=DEFAULT_SENSORS[CONF_SOLAR_ENERGY]): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(CONF_LOAD_POWER, default=DEFAULT_SENSORS[CONF_LOAD_POWER]): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(CONF_LOAD_ENERGY, default=DEFAULT_SENSORS[CONF_LOAD_ENERGY]): _OPTIONAL_ENTITY_SCHEMA,
        ...
        vol.Optional(
            CONF_GRID_IMPORT_ENERGY, default=DEFAULT_SENSORS[CONF_GRID_IMPORT_ENERGY]
        ): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(
            CONF_GRID_EXPORT_ENERGY, default=DEFAULT_SENSORS[CONF_GRID_EXPORT_ENERGY]
        ): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(CONF_BATTERY_POWER, default=DEFAULT_SENSORS[CONF_BATTERY_POWER]): cv.entity_id,
        vol.Optional(
            CONF_BATTERY_INVERTER_POWER,
            default=DEFAULT_SENSORS[CONF_BATTERY_INVERTER_POWER],
        ): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(
            CONF_BATTERY_CHARGE_POWER,
        ...
        vol.Optional(
            CONF_BATTERY_CHARGE_ENERGY,
            default=DEFAULT_SENSORS[CONF_BATTERY_CHARGE_ENERGY],
        ): _OPTIONAL_ENTITY_SCHEMA,
        vol.Optional(
            CONF_BATTERY_DISCHARGE_POWER,
        ...
        vol.Optional(
            CONF_BATTERY_DISCHARGE_ENERGY,
            default=DEFAULT_SENSORS[CONF_BATTERY_DISCHARGE_ENERGY],
        ): _OPTIONAL_ENTITY_SCHEMA,
